      ...
      <Card className="border-slate-800 bg-linear-to-br from-slate-900 via-slate-900 to-violet-950/30 overflow-hidden relative">
        ...
        <CardHeader className="pb-4">
          ...
          <CardTitle className="text-2xl md:text-3xl text-white font-semibold">
            Controle dos Usuários da Semcomp
          </CardTitle>
          <CardDescription className="text-slate-400 mt-1">
            Busque participantes, acesse e edite informações, mantenha controle sobre os usuários inscritos para a Semana da Computação.
          </CardDescription>
        </CardHeader>
        <CardContent>
