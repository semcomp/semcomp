...
export default function LoginPage(): ReactElement {
    ...
    // Lógica para deficiência (Multivalorado)
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (isLogin) {
                ...
                if (!acceptTerms) {
                    showNotification("Você deve aceitar os termos de serviço.", "warning");
    ...
    }, [validate, isLogin, email, password, showNotification, login, register, acceptTerms, setIsLogin]);

    // --- CONTEÚDO DO FORMULÁRIO OTIMIZADO ---
    // Se for cadastro, aumentamos o max-w para acomodar 2 colunas (max-w-lg)
    const formContent = (
    ...
    return (
        <>
            <div className={`min-h-[calc(100vh-80px)] py-6 w-full flex items-center justify-center ${bgColor} overflow-hidden`}>
