...
import CreateRiddlethonQuestionModal from './create-riddlethon-question-modal';
import UpdateRiddlethonQuestionModal from './update-riddlethon-question-modal';
 ...
 * @return {object}
 */
function RiddlethonQuestions() {
  const {
    data: questions,
    isFetching: isFetchingQuestions,
    setData: setQuestions,
  } = useFecthData(API.getRiddlethonQuestions);
  ...
  const {
    ...
    deleteDataFunction: API.deleteRiddlethonQuestions,
  });
...
export default RiddlethonQuestions;
