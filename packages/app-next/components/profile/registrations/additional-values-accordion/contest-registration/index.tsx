...
function ContestRegistration({ updateFormValue, registerTeam }) {
  ...
  const scholarshipRef: any = useRef();
  const courseRef: any = useRef();
  const entranceRef: any = useRef();

  const technicalExpRef: any = useRef();
  const resolutionExpRef: any = useRef();
  const contestExpRef: any = useRef();
