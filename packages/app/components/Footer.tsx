    ...
    <footer className="flex items-center justify-around bg-primary text-white p-16">
      ...
      <section className="text-center">
        ...
        <div className="flex p-2">
          <SocialLinkIcon link="https://www.facebook.com/Semcomp/" icon={<FacebookIcon/>} />
          <SocialLinkIcon link="https://www.youtube.com/channel/UCPF97UIRX8AnkS9gU907g1Q" icon={<YouTubeIcon/>} />
          <SocialLinkIcon link="https://instagram.com/semcomp" icon={<InstagramIcon/>} />
          <SocialLinkIcon link="https://www.linkedin.com/company/semcomp/" icon={<LinkedInIcon/>} />
          <SocialLinkIcon link="https://twitter.com/semcomp" icon={<TwitterIcon/>} />
        </div>
      </section>
    </footer>
  </>);
