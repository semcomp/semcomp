...
function CoffeeStep2({data, setData}: {data: CoffeePaymentData, setData: any}) {
  function handleWithSocialBenefitChange(event: React.ChangeEvent<HTMLInputElement>) {
    const value = event.target.checked;
    setData({...data,withSocialBenefit: value});
  };

  function handleSocialBenefitNumberChange(event: React.ChangeEvent<HTMLInputElement>) {
