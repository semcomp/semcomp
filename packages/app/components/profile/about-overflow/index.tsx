...
function AboutOverflow({ onRequestClose }) {
  return (
    ...
    <main className="container mx-auto py-8">
        ...
        <p className="text-sm text-center mb-4">A divisão de pessoas é feita de forma uniforme, para que todos os times tenham um número parecido de participantes. Não é possível alterar <span className="text-primary font-bold">sua casa</span>. Para a Semcomp 26, as equipes serão: <span className="text-primary font-bold">Rock</span>, <span className="text-primary font-bold">Pop</span>, <span className="text-primary font-bold">Funk</span> e <span className="text-primary font-bold">Indie</span>.</p>
        ...
        <p className="text-sm text-center mb-4">Ao final da semana, teremos o Encerramento da Semcomp. Nele, serão revelados os vencedores das competições, quantos pontos cada casa recebeu e, finalmente, a grande campeã do Overflow! Vale lembrar que todos da equipe vencedora ganharão uma lembrança da tão honrada conquista.</p>
