...
function AboutOverflow({ onRequestClose }) {
  return (
    ...
    <main className="container mx-auto py-8">
        ...
        <p className="text-sm text-center mb-4">A divisão de pessoas é feita de forma uniforme, para que todos os times tenham um número parecido de participantes. Não é possível alterar <span className="text-primary font-bold">sua casa</span>. Para a Semcomp 27, as equipes serão: <span className="text-primary font-bold">Stormrock</span>, <span className="text-primary font-bold">Symbiosia</span>, <span className="text-primary font-bold">Cybertechna</span> e <span className="text-primary font-bold">Arcadium</span>.</p>
