...
function AboutOverflow({ onRequestClose }) {
  return (
    <Modal onRequestClose={onRequestClose} maxHeight="70vh">
      <div className="bg-primary text-white w-full h-fit text-xl text-white py-6 flex items-center justify-center text-center">
        Sobre o Overflow
      </div>
      <div className="content p-6 overflow-y-scroll">
        ...
        <main className="mx-auto pt-8">
          ...
          <p className="text-sm text-center mb-4">A divisão de pessoas é feita de forma uniforme, para que todos os times tenham um número parecido de participantes. Não é possível alterar <span className="text-primary font-bold">sua casa</span>. Para a Semcomp {config.EDITION}, as equipes serão: <span className="text-primary font-bold">Semanal</span>, <span className="text-primary font-bold">Fire Wall</span>, <span className="text-primary font-bold"> Monte Carlo</span> e <span className="text-primary font-bold">S28</span>.</p>
