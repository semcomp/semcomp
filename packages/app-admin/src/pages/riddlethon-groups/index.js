 ...
 * @return {object}
 */
function RiddlethonGroups() {
  const {
    data: groups,
    isFetching: isFetchingGroups,
    setData: setGroups,
  } = useFecthData(API.getRiddlethonGroups);
  ...
  const {
    ...
    deleteDataFunction: API.deleteRiddlethonGroup,
  });
...
export default RiddlethonGroups;
