  ...
  implements PaymentIntegrationService
{
  ...
  public async create(
    ...
    const createPaymentResponse = (
      await axios.post("https://api.mercadopago.com/v1/payments", paymentData, {
        headers: headers,
      })
    ).data;
    ...
    const response = {
      ...
      qrCode:
        createPaymentResponse.point_of_interaction.transaction_data.qr_code,
      qrCodeBase64:
        createPaymentResponse.point_of_interaction.transaction_data
          .qr_code_base64,
    };
