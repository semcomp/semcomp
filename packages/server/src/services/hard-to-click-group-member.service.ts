...
class HardToClickGroupMemberService {
  public async find(filters?: Partial<HardToClickGroupMember>): Promise<HardToClickGroupMember[]> {
  ...
  public async count(filters?: Partial<HardToClickGroupMember>): Promise<number> {
