...
class AuthService {
  ...
  public async signup(user: User, disabilities: Disability[]): Promise<User> {
    ...
    await emailService.send(
      ...
      <p>Se prepare para a 26&deg; edi&ccedil;&atilde;o Beta da maior Semana de Computa&ccedil;&atilde;o do Brasil! Aproveite o gostinho do que está por vir ao participar das nossas palestras, minicursos, concursos e eventos culturais!</p>
