...
class AuthService {
  ...
  public async signup(user: User, disabilities: Disability[]): Promise<User> {
    ...
    await emailService.send(
      createdUser.email,
      "Bem vinde à Semcomp 25!",
      `Você se cadastrou no nosso site e já está tudo certo!
      Se prepare para a 25° edição da maior Semana de Computação do Brasil! Aproveite o melhor das nossas palestras, minicursos, concursos e eventos culturais!
